    ...
    if ($count > 0)
    {
        ...
        while($row = mysqli_fetch_assoc($res))
        {
            ...
            if ($index % 2 == 0)
            {
                ...
                ?>
                <div style="background-image: url(images/destinations/<?php echo $image ?>)" class='card mobile' ></div>
                ...
                <div style="background-image: url(images/destinations/<?php echo $image ?>)" class='card desktop' ></div>
                <?php
            }
            else
            {
                ...
                //get and print the values from individual columns
                ?>
                <div style="background-image: url(images/destinations/<?php echo $image ?>)" class='card' ></div>
                <?php
